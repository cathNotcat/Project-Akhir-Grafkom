...
public class Quadric2 extends Circle{
    ...
    public Quadric2(List<ShaderModuleData> shaderModuleDataList, List<Vector3f> vertices, Vector4f color, Vector3f cp, Float rx, Float ry, Float rz, String choice) {
...
//                "lightPos",
//                new Vector3f(1.0f,1.0f,0.0f));
        uniformsMap.setUniform("dirLight.direction", new Vector3f(0.0f, 0.0f, 0f));
        ...
        uniformsMap.setUniform("spotLight.direction", camera.getPosition());
        ...
        uniformsMap.setUniform("spotLight.specular", new Vector3f(1f, 1f, 1f));
